...
<script type="application/javascript">
    ...
    function changeStatusModal(elem,$appId){

        $('#modal_status_id').val($appId)
            ...
            buttons: [
                {
                    extend: 'print',
                    footer: true,
                    title:'Edu Brokers Applications:',
                    exportOptions: {
    ...
    function marKFeatured(elem,userId) {

        $.post('{{ route('marKFeatured') }}', {_token: '{{ csrf_token() }}', userId:userId,status:$(elem).val()}, function (data) {});

    }

    function marKHbcu(elem,userId) {

        $.post('{{ route('marKHbcu') }}', {_token: '{{ csrf_token() }}', userId:userId,status:$(elem).val()}, function (data) {});

    }

    function activeInActive(elem,userId) {

        $.post('{{ route('activeInActive') }}', {_token: '{{ csrf_token() }}', userId:userId,status:$(elem).val()}, function (data) {
