                                        ...
                                        <tr valign="bottom">
                                            ...
                                            <td class="ppsans" style="font-family:Calibri, Trebuchet, Arial, sans serif; font-size:15px; line-height:22px; color:#333333;" valign="top">
                                                <div style="margin-top: 30px;color:#333 !important;font-family: arial,helvetica,sans-serif;font-size:12px;">
                                                    <h3 style="color:#333333 !important;font-weight:bold;font-family: arial,helvetica,sans-serif;text-align: center;width: 100%;display: inline-block;">Edu Brokers Forgot Password!</h3>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <table border="0" cellpadding="0" cellspacing="0" contenteditable="false" style="width:100%; color:#333 !important;font-family: arial,helvetica,sans-serif;font-size:12px;margin-top: 10px;">
                                                                    <tbody>
                                                                    <tr>
                                                                        <td style="width:100%;text-align: center;display: inline-block;padding: 31px 0px 0px 0px; font-size: 16px">We've received a password reset request against your account.</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="width:100%;text-align: center;display: inline-block;padding: 31px 0px 0px 0px; font-size: 16px">Please visit Below Link to reset your password.</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="width:100%;text-align: center;display: inline-block;padding: 31px 0px 0px 0px; font-size: 16px"><a href="{{ route('resetUserPassword',$data['auth_code']) }}"> Click here</a> to reset password</td>
                                                                    </tr>
                                                                    <tr>
