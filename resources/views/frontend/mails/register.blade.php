                                        ...
                                        <tr valign="bottom">
                                            ...
                                            <td class="ppsans" style="font-family:Calibri, Trebuchet, Arial, sans serif; font-size:15px; line-height:22px; color:#333333;" valign="top">
                                                <div style="margin-top: 30px;color:#333 !important;font-family: arial,helvetica,sans-serif;font-size:12px;">
                                                    <h3 style="color:#333333 !important;font-weight:bold;font-family: arial,helvetica,sans-serif;text-align: center;width: 100%;display: inline-block;">Edu Brokers Account Registration!</h3>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <table border="0" cellpadding="0" cellspacing="0" contenteditable="false" style="width:100%; color:#333 !important;font-family: arial,helvetica,sans-serif;font-size:12px;margin-top: 10px;">
                                                                    <tbody>
                                                                    <tr>
                                                                        <td style="width:100%;text-align: center;display: inline-block;padding: 31px 0px 30px 0px; font-size: 16px">Congratulations you've successfully created your Edu Brokers account. <br> Please complete other signup steps to fully unlock your account.</td>
                                                                    </tr>
                                                                    <tr>
