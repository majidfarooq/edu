                                ...
                                <td align="center" bgcolor="#ffffff" valign="top">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" contenteditable="false" style="padding-top: 15px !important;padding-bottom: 30px !important;margin-bottom: 0;width: 100%;text-align: center;">
                                        ...
                                        <tr valign="bottom">
                                            ...
                                            <td align="" height="64">
                                                <img alt="Wheels Near Me" border="0" height="46" src="http://34.67.79.242/gts/public/assets/frontend/images/logo.png" style="width: auto;">
                                            </td>
                                        ...
                                        <tr valign="bottom">
                                            ...
                                            <td class="ppsans" style="font-family:Calibri, Trebuchet, Arial, sans serif; font-size:15px; line-height:22px; color:#333333;" valign="top">
                                                <div style="margin-top: 30px;color:#333 !important;font-family: arial,helvetica,sans-serif;font-size:12px;">
                                                    <h3 style="color:#333333 !important;font-weight:bold;font-family: arial,helvetica,sans-serif;text-align: center;width: 100%;display: inline-block;">Your email verification code is below you can use it to verify your email with <b>GTS</b></h3>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <table border="0" cellpadding="0" cellspacing="0" contenteditable="false" style="width:100%; color:#333 !important;font-family: arial,helvetica,sans-serif;font-size:12px;margin-top: 10px;">
                                                                    <tbody>
                                                                    <tr>
                                                                        <td style="width:100%;text-align: center;display: inline-block;padding: 31px 0px 30px 0px; font-size: 16px">Use this code to verify your email</td>
                                                                        <td style="width:100%;text-align: center;padding: 0px 0px 30px 0px;display: inline-block;font-weight: bold;font-size: 16px"><span style="display: inline;">@if(isset($data['code'])) {{$data['code']}} @endif</span></td>
                                                                    </tr>
