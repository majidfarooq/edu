                                ...
                                <td align="center" bgcolor="#ffffff" valign="top">
                                    <table border="0" cellpadding="0" cellspacing="0" contenteditable="false" style="padding-top: 15px !important;padding-bottom: 30px !important;margin-bottom: 0;width: 100%;text-align: center;">
                                        ...
                                        <tr valign="bottom">
                                            ...
                                            <td align="" height="64">
                                                <img alt="Edu Brockers" border="0" height="46" src="https://cloud.ferozitech.com/edu/public/assets/frontend/images/banner-logo.png" style="width: auto;">
                                            </td>
                                        ...
                                        <tr valign="bottom">
                                            ...
                                            <td class="ppsans" style="font-family:Calibri, Trebuchet, Arial, sans serif; font-size:15px; line-height:22px; color:#333333;" valign="top">
                                                <div style="margin-top: 30px;color:#333 !important;font-family: arial,helvetica,sans-serif;font-size:12px;">
                                                    <h3 style="color:#333333 !important;font-weight:bold;font-family: arial,helvetica,sans-serif;text-align: center;width: 100%;display: inline-block;">Edu Brockers Contact us!</h3>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <table border="0" cellpadding="0" cellspacing="0" contenteditable="false" style="width:100%; color:#333 !important;font-family: arial,helvetica,sans-serif;font-size:12px;margin-top: 10px;">
                                                                    <tbody>
                                                                    <tr>
                                                                        <td style="width:100%;text-align: center;display: inline-block;padding: 31px 0px 30px 0px; font-size: 16px">Name:  @if(isset($data['name'])){{$data['name']}}@endif</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="width:100%;text-align: center;display: inline-block;padding: 31px 0px 30px 0px; font-size: 16px">Phone: @if(isset($data['phone'])){{$data['phone']}}@endif</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="width:100%;text-align: center;display: inline-block;padding: 31px 0px 30px 0px; font-size: 16px">Email: @if(isset($data['email'])){{$data['email']}}@endif</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="width:100%;text-align: center;display: inline-block;padding: 31px 0px 30px 0px; font-size: 16px">Subject:  @if(isset($data['subject'])){{$data['subject']}}@endif</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="width:100%;text-align: center;display: inline-block;padding: 31px 0px 30px 0px; font-size: 16px">Message: @if(isset($data['message'])) {{ $data['message'] }} @endif</td>
                                                                    </tr>
                                                    ...
                                                    <span style="font-size:11px;color:#333;text-align: center;margin: 0 auto !important;width: 100%;display: block;">We're happy to chat if you need any assistance. Please reach out to us at <a style="font-size:11px;" href="mailto:universitysupport@edubrokers.com">universitysupport@edubrokers.com.</a></span>
                                                    ...
                                                    <br>
                                                    <span style="font-size:11px;color:#333;text-align: center;margin: 0 auto !important;width: 100%;display: block;">This message was mailed to @if(isset($data['user_email'])){{ $data['user_email'] }} @endif by Edu Brokers</span>
                                                </div>
                                                <p></p>
