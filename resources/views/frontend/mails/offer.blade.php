                                        ...
                                        <tr valign="bottom">
                                            ...
                                            <td class="ppsans" style="font-family:Calibri, Trebuchet, Arial, sans serif; font-size:15px; line-height:22px; color:#333333;" valign="top">
                                                <div style="margin-top: 30px;color:#333 !important;font-family: arial,helvetica,sans-serif;font-size:12px;">
                                                    <h3 style="color:#333333 !important;font-weight:bold;font-family: arial,helvetica,sans-serif;text-align: center;width: 100%;display: inline-block;">Congratulations on getting an offer.</h3>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <table border="0" cellpadding="0" cellspacing="0" contenteditable="false" style="width:100%; color:#333 !important;font-family: arial,helvetica,sans-serif;font-size:12px;margin-top: 10px;">
                                                                    <tbody>
                                                                    <tr>
                                                                        <td style="width:100%;text-align: center;display: inline-block;padding: 31px 0px 0px 0px; font-size: 16px">Hello {{ $data['student'] }}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="width:100%;text-align: center;display: inline-block;padding: 31px 0px 0px 0px; font-size: 16px">Congratulations on getting an offer. You’re just a click away from becoming a {{ $data['university'] }} student!
                                                                            Now you simply need to log in to your account and accept the offer. You can do that from your Dashboard under the Offers section.
                                                                            Please hurry up before the seat gets filled by another applicant. </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="width:100%;text-align: center;display: inline-block;padding: 31px 0px 0px 0px; font-size: 16px">
                                                                            <a href="{{ route('home') }}">Click Here to View Your Offer</a>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="width:100%;text-align: center;display: inline-block;padding: 31px 0px 0px 0px; font-size: 16px">
                                                                    ...
                                                                    <tr>
                                                                        <td style="width:100%;text-align: center;display: inline-block; font-size: 16px">
                                                                           <img alt="GTS" border="0" height="46" src="http://cloud.ferozitech.com/edu/public/assets/frontend/images/banner-logo.png" style="width: auto;">
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
